...
var _ticker = _interopRequireDefault(require("rc-tween-one/lib/ticker"));
...
var ScrollParallax = /*#__PURE__*/function (_React$Component) {
  ...
  function ScrollParallax(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "scrollEventListener", function () {
      ...
      _ticker["default"].clear(_this.tickerId);
      ...
      var startFrame = _ticker["default"].frame;

      _ticker["default"].wake(_this.tickerId, function () {
        var moment = (_ticker["default"].frame - startFrame) * _ticker["default"].perFrame;

        var ratio = _tweenFunctions["default"].easeOutQuad(moment, 0.08, 1, 300);
  ...
  _createClass(ScrollParallax, [{
    ...
    value: function componentDidMount() {
      ...
      _EventDispatcher["default"].addEventListener(this.eventResize, this.resizeEventListener, this.target); // 预注册;


      this.timeline.frame(0);
      this.scrollEventListener();

      _EventDispatcher["default"].addEventListener(this.eventType, this.scrollEventListener, this.target);
    }
  }, {
    ...
    value: function componentWillUnmount() {
      ...
      _EventDispatcher["default"].removeEventListener(this.eventResize, this.resizeEventListener, this.target);
    }
  }, {
    key: "render",
    value: function render() {
      ...
      props.style = style;
      return /*#__PURE__*/_react["default"].createElement(this.props.component, _objectSpread(_objectSpread(_objectSpread({}, props), componentProps), {}, {
        ref: this.domRef
      }));
    }
  }], [{
