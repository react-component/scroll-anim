...
var ScrollScreenClass = function ScrollScreenClass() {
  ...
  _defineProperty(this, "init", function (vars) {
    ...
    _EventDispatcher["default"].addEventListener('wheel.scrollWheel', _this.onWheel, null, passive); // dom 在 didMount 后高度没出来，加 setTimeout; 
  ...
  _defineProperty(this, "unMount", function () {
    _EventDispatcher["default"].removeEventListener('wheel.scrollWheel', _this.onWheel);
  });
  ...
  _defineProperty(this, "raf", function () {
    ...
    var easeValue = _tweenFunctions["default"][_this.vars.ease](progressTime, _this.scrollTop, _this.toHeight, duration);
