...
var _ScrollElement2 = _interopRequireDefault(require("./ScrollElement"));
    ...
    _defineProperty(_assertThisInitialized(_this), "scrollEventListener", function (e) {
      ...
      if (_this.enter || !replay && isTop) {
        ...
        if (!always && _this.eventType) {
          _EventDispatcher["default"].removeEventListener(_this.eventType, _this.scrollEventListener, _this.target);
        }
      } else if (always) {
  ...
  _createClass(ScrollOverPack, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (prevProps !== this.props) {
        ...
        var inListener = _EventDispatcher["default"]._listeners.scroll && _EventDispatcher["default"]._listeners.scroll.some(function (c) {
    ...
    value: function render() {
      ...
      if (_util.windowIsUndefined) {
        return /*#__PURE__*/(0, _react.createElement)(component, _objectSpread(_objectSpread({}, props), componentProps), props.children);
      }
      ...
      if (!this.oneEnter) {
        ...
        var children = (0, _util.toArrayChildren)(props.children).map(function (item) {
          ...
          return item.type.isTweenOne ? /*#__PURE__*/_react["default"].cloneElement(item, _objectSpread(_objectSpread({}, item.props), {}, {
            key: key,
            paused: !show
          })) : /*#__PURE__*/_react["default"].cloneElement(item, _objectSpread(_objectSpread({}, item.props), {}, {
            key: key
          }), show && item.props.children);
        });
        childToRender = /*#__PURE__*/(0, _react.createElement)(component, _objectSpread(_objectSpread({}, props), componentProps), children);
        this.oneEnter = true;
      } else {
        if (!this.state.show) {
        ...
        childToRender = /*#__PURE__*/(0, _react.createElement)(component, _objectSpread(_objectSpread({}, props), componentProps), this.children);
      }
...
_defineProperty(ScrollOverPack, "propTypes", {
  ...
  scrollEvent: _propTypes["default"].func,
