	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            _rcTweenOne2['default'],
	            { className: 'tween-one', animation: { opacity: 1 }, key: 't', hideProps: { reverse: true } },
	            '只从上往下时播放'
	          ),
	          _react2['default'].createElement(
	            _rcAnimate2['default'],
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            _rcTweenOne2['default'],
	            { animation: { opacity: 1 }, key: 't', className: 'tween-one', style: { opacity: 0 }, hideProps: { reverse: true } },
	            '只进入一次'
	          ),
	          _react2['default'].createElement(
	            _rcAnimate2['default'],
