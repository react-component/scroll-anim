  ...
  render() {
    return (<div>
      ...
      <div className="pack-page"
        ...
        <ScrollParallax vars={{opacity: 1}} style={{opacity: 0, paddingTop: 60}}
                        className="tween-one">transform 必需在 style 里设定初始值</ScrollParallax>
        <ScrollParallax vars={{opacity: 1}} style={{opacity: 0, paddingTop: 0, fontSize: 24}}
                        className="tween-one">默认显示位置[0 ,1]</ScrollParallax>
        <ScrollParallax vars={{scaleX: 1, scaleY: 1}} style={{transform: 'scale(0)', color: '#fff'}}
                        className="demo parallax-shape">Scale</ScrollParallax>
        <ScrollParallax vars={{rotate: 360}} style={{transform: 'rotate(0)'}}
                        className="demo2 parallax-shape">rotate</ScrollParallax>
        <ScrollParallax vars={{x: 0, opacity: 1}}
      ...
      <div className="pack-page"
        ...
        <ScrollParallax vars={{translateY: 120, opacity: 1, ease: 'linear', playScale: [0, 2]}}
        ...
        <ScrollParallax vars={{translateY: -100, opacity: 1, ease: 'linear', playScale: [0, 1]}}
      ...
      <ScrollElement style={{height: 2000}} scrollName="Scroll-Pack">
        <ScrollParallax className="pack-page"
          ...
          <ScrollParallax vars={{translateX: '0%', playScale: [1, 2]}}
                          style={{transform: 'translateX(-100%)', backgroundColor: '#F38EAD', width: '100%', height: '100%', position: 'absolute'}}
                          location="Scroll-Pack"/>
          <ScrollParallax vars={[{translateY: 0}, {translateY: '450px'}]}
                          location="Scroll-Pack"
